...
//	public ConfigScreen(final ITextComponent titleIn, final Screen parentScreen, final ModContainer modContainer, final List<IConfigElement>) {
//		super(titleIn);
//		this.parentScmreen = parentScreen;
//		this.modContainer = modContainer;
//	}

	public ConfigScreen(final Screen parentScreen, final ModContainer modContainer) {
		this(new StringTextComponent(modContainer.getModInfo().getDisplayName()), parentScreen, modContainer);
	}

	public ConfigScreen(final Minecraft minecraft, final Screen parentScreen, final ModContainer modContainer) {
		this(parentScreen, modContainer);
		this.minecraft = minecraft;
	}

//	/**
//	 * This constructor makes a screen for all the {@code @Config} configuration classes of the mod
//	 *
//	 * @param parentScreen the parent Screen object
//	 * @param modContainer        the modContainer of the mod for which to create a screen
//	 */
//	public ConfigScreen(Screen parentScreen, String modContainer, String title) {
//		this(parentScreen, modContainer, false, false, title, ConfigManager.getModConfigClasses(modContainer));
//	}
