 ...
 * period of time. The region can be defined manually or by supplying a Widget object.
 *
 * @author bspkrs
 */
public class HoverChecker
{
     ...
     * It is not necessary to call this method if a Widget defines the hover region.
     */
     ...
     * If the specified time period has elapsed the method returns true.
