...
public class FloatConfigValueElement implements IConfigValueElement<Float> {

	final EntryConfigValue<Float> entryConfigValue;

	public FloatConfigValueElement(final List<String> path, final ModConfig modConfig, final ConfigValue<Float> configValue) {
	...
	public ConfigListEntry makeConfigEntry(final ConfigScreen configScreen, final ConfigEntryListWidget configEntryListScreen) {
		return new FloatConfigListEntry(this, configScreen, configEntryListScreen);
	}
	...
	@Override
	public void set(final Float[] aVal) {
	}
