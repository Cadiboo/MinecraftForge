...
public class IntegerConfigListEntry extends ConfigListEntry {
	...
	private final IntegerConfigValueElement longConfigValueElement;
	...
	public IntegerConfigListEntry(final IntegerConfigValueElement configValueElement, final ConfigScreen configScreen, final ConfigEntryListWidget configEntryListScreen) {
		...
		this.textFieldWidget.func_212954_a(s -> {
			if (!this.isValidValue())
				return;
			longConfigValueElement.set(Integer.valueOf(s));
		});
	}
	...
	public boolean isValidValue() {
		try {
			Integer.parseInt(this.textFieldWidget.getText());
			return true;
